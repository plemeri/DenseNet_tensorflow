...
def args():
    ...
    parser.add_argument('--test_record_dir', type=str, default='./dataset/mnist/test.tfrecord', help='directory for test record')  # directory for test images
